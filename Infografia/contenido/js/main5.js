...
function actualizaPosicion(elPorciento) {
	...
	if (elPorcientoFinal > 0.0001 && elPorcientoFinal < 0.0648 && visto_1 === 0) {
		// console.log("🚨");
		// animacion_entrada("#img1", "default", 0.5);
		// animacion_entrada("#img2", "default", 0.5);
		// animacion_entrada("#img6", "der_izq", 1);
		// animacion_entrada("#img5", "der_izq", 1);
		// animacion_entrada("#img3", "izq_der", 1.5);
		// animacion_entrada("#img4", "izq_der", 2);
		// animacion_entrada("#img9", "arriba_abajo", 2.5);
		// animacion_entrada("#img7", "arriba_abajo", 3);
		visto_1 = 1;
	}
	if (elPorcientoFinal > 0.1945 && elPorcientoFinal < 0.4213 && visto_2 === 0) {
		//  console.log("🚨");
		animacion_entrada('#img11', 'default', 0.5);
		animacion_entrada('#img10', 'arriba_abajo', 1);
		animacion_entrada('#img12', 'der_izq', 1.5);
		animacion_entrada('#img13', 'abajo_arriba', 2);
		animacion_entrada('#img22', 'arriba_abajo', 2.5);
		animacion_entrada('#img14', 'arriba_abajo', 3);
		visto_2 = 1;
	}
	if (elPorcientoFinal > 0.8427 && visto_3 === 0) {
		// console.log("🚨");
		animacion_entrada('#img16', 'default', 0.5);
		animacion_entrada('#img15', 'arriba_abajo', 1);
		animacion_entrada('#img17', 'der_izq', 1.5);
		setTimeout(function() {
			animacion_salida('#img17', 'default', 0);
			animacion_salida('#img15', 'default', 0);

			animacion_entrada('#img18', 'der_izq', 0.5);
			animacion_entrada('#img19', 'arriba_abajo', 1);
			animacion_entrada('#img20', 'arriba_abajo', 1);
			animacion_entrada('#img21', 'der_izq', 2);
		}, 5000);

		visto_3 = 1;
	}
	// if (elPorcientoFinal > 0.1700 && elPorcientoFinal < 0.1800 && visto_4 === 0) {
	//   console.log("🚨");
	//   visto_4 = 1;
	// }
