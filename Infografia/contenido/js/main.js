...
function actualizaPosicion(elPorciento) {
	...
	if (elPorcientoFinal > 0.07 && elPorcientoFinal < 0.1 && visto_1 === 0) {
		// console.log("🚨");
		animacion_entrada('#Secc1_img01', 'der_izq', 0);
		animacion_entrada('#Secc1_img02', 'der_izq', 0);
		animacion_entrada('#Secc1_img03', 'der_izq', 0);
		animacion_entrada('#Secc1_img04', 'der_izq', 0);
		animacion_entrada('#Secc1_img05', 'der_izq', 0);
		animacion_entrada('#Secc1_img06', 'der_izq', 0);
		animacion_entrada('#Secc1_img07', 'der_izq', 0);
		animacion_entrada('#Secc1_img08', 'der_izq', 0);
		animacion_entrada('#Secc2', 'der_izq', 0);
		animacion_entrada('#Secc2_img01', 'der_izq', 0);
		animacion_entrada('#Secc2_img02', 'der_izq', 0);
		animacion_entrada('#Secc2_img02', 'der_izq', 0);
		visto_1 = 1;
	}
